...
export class PollsController {
  ...
  @ApiOperation({ summary: 'Get all polls', description: 'Returns polls, optionally filtered by event or status. Accessible by client, eventmanager, osc, attendee, and superuser.' })
