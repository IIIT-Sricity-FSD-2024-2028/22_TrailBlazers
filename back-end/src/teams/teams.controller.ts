...
export class TeamsController {
  ...
  @ApiOperation({ summary: 'Add team member to event', description: 'Assign a new OSC staff member to an event. Eventmanager only.' })
  ...
  @Patch(':id')
  @Roles(Role.EVENTMANAGER)
  @ApiOperation({ summary: 'Update team member (status, role, event)', description: 'Eventmanager can change any field.' })
  @ApiHeader({ name: 'role', description: 'superuser | eventmanager', required: true, example: 'eventmanager' })
  @ApiParam({ name: 'id', description: 'Team member ID' })
