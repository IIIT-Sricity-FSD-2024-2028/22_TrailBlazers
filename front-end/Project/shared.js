      ...
      <div class="sh-user-wrap">
        <div class="sh-user" id="sh-profileBtn">
          <div class="sh-user-info">
            <span class="sh-user-name">Alex Thompson</span>
            <span class="sh-user-role">Lead Coordinator</span>
          </div>
          <div class="sh-avatar">AT</div>
          <i class="fa-solid fa-chevron-down sh-chevron"></i>
        </div>
        <div class="sh-dropdown" id="sh-profileDropdown">
          <div class="sh-dd-head">
            <div>
              <div class="sh-dd-name">Alex Thompson</div>
              <div class="sh-dd-role">Lead Coordinator</div>
            </div>
            <div class="sh-avatar sm">AT</div>
          </div>
          <div class="sh-dd-body">
            <div class="sh-dd-row"><i class="fa-regular fa-user"></i> Alex Thompson</div>
            <div class="sh-dd-row"><i class="fa-regular fa-envelope"></i> alex.t@evnt.com</div>
            <div class="sh-dd-row"><i class="fa-regular fa-shield"></i> Lead Coordinator</div>
          </div>
